...
function ui_tree_coltypes($list=false,$padding = array()){
	...
	foreach ($list as $k => $v) {
		...
		// if ($v['flag']) {
		// 	$tree.= '<a href="'.'#'.' " title="'.lang('flag').'" class="btn btn-primary btn-small btn-ajax-flag" data-id='.$v['id'].' data-flag="0"> <i class="fa fa-flag" ></i> </a>';
		// } else {
		// 	$tree.= '<a href="'.'#'.' " title="'.lang('flag').'" class="btn btn-small btn-ajax-flag" data-id='.$v['id'].' data-flag="1"> <i class="fa fa-flag"></i> </a>';
		// }
