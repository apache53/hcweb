				...
				<div class="controls">
					<div class="btn-group">
						<span class="btn btn-success">
							...
							<!-- <input class="fileupload" type="file"  accept="" multiple="" data-for="thumb"> -->
						</span>
						...
						<!-- <input type="hidden" name="photo" class="form-upload" value=""  data-more="1">
						<input type="hidden" name="thumb" class="form-upload-thumb" value=""> -->
					</div>
				</div>
			</div>
...
require(['media'],function(media){
	var honor_photos = <?php echo json_encode(list_upload(set_value('photo'))) ?>;
	// 加载图片
	media.init();
