...
<div class="btn-group"><a href="<?php echo site_urlc('journals/index');?>" class="btn"> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?> </a></div>
...
require(['adminer/js/ui','adminer/js/media','bootstrap-datetimepicker.zh'],function(ui,media){
	...
	var journalss_photos = <?php echo json_encode(one_upload($it['photo'])) ?>;
	media.init();
	media.show(journalss_photos,"photo");
});
</script>
