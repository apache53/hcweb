...
<div class="btn-group"><a href="<?php echo site_urlc('news/index');?>" class="btn"> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?> </a></div>
...
<div class="boxed">
	...
	<?php echo form_open(current_urlc(), array('class' => 'form-horizontal', 'id' => 'frm-edit')); ?>
		...
		<div class="boxed-inner seamless">
			...
			<div class="control-group">
				<label for="phone" class="control-label">一键联系</label>
				<div class="controls">
					<input type="text" name="phone" id="phone" value="<?php echo set_value('phone',$it['phone']); ?>"  placeholder="一键联系" required=1>
					<span class="help-inline"></span>
				</div>
			</div>
...
require(['adminer/js/ui','adminer/js/media','bootstrap-datetimepicker.zh'],function(ui,media){
	...
	var newss_photos = <?php echo json_encode(one_upload($it['photo'])) ?>;
	media.init();
