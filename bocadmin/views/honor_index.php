...
require(['adminer/js/ui'],function(ui){
	var honor = {
		del: "<?php echo site_urlc('honor/delete'); ?>"
		,audit: "<?php echo site_urlc('honor/audit'); ?>"
		,url_sort: "<?php echo site_urlc('honor/sortid'); ?>"
	};
	
	ui.fancybox_img();
	ui.btn_delete(honor.del);		// 删除
	ui.btn_audit(honor.audit);	// 审核
	ui.sortable(honor.url_sort);	// 排序
});
</script>
