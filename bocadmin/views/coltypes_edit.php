				...
				<div class="controls">
					<div class="btn-group">
						<span class="btn btn-success">
							...
							<span> 类型封面
							<?php if (in_array($this->cid, array(1, 4))): ?>
								(750x285)
							<?php endif ?>
							</span>
							<input class="fileupload" type="file" accept="">
						</span>
						<input type="hidden" name="photo" class="form-upload" data-more="1" value="<?php echo set_value('photo',$it['photo']) ?>">
...
require(['adminer/js/media'],function(media){
	var coltypes_photos = <?php echo json_encode(list_upload(set_value('photo',$it['photo']))) ?>;
	media.init();
